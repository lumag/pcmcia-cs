...
#define TX_TIMEOUT		(HZ) /* 1 second timeout */
...
#ifndef spin_lock_bh
static long __flags;
#define spin_lock_bh(lock) spin_lock_irqsave(lock, __flags)
#define spin_unlock_bh(lock) spin_unlock_irqrestore(lock, __flags)
#endif
